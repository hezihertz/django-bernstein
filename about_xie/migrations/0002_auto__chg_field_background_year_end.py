...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Background.year_end'
        db.alter_column('about_xie_background', 'year_end', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Background.year_end'
        db.alter_column('about_xie_background', 'year_end', self.gf('django.db.models.fields.IntegerField')(default=0))
