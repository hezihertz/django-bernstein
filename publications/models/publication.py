...
class Publication(models.Model):
	...
	CATEGORY_CHOICES = (
			('single_cell_genomics', 'Single Cell Genomics'),
	...
	category = models.CharField(max_length=128, choices=CATEGORY_CHOICES, blank=True, help_text='The subfield this publication belongs to')
