...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'publications_publication', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Publication.category'
        db.add_column(u'publications_publication', 'category',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'publications_publication', 'featured')

        # Deleting field 'Publication.category'
        db.delete_column(u'publications_publication', 'category')
